...
class DocumentationContractTests(unittest.TestCase):
    ...
    def test_readme_links_the_independent_operator_walkthrough(self) -> None:
        readme = (ROOT / "README.md").read_text(encoding="utf-8")
        self.assertIn("](docs/EXISTING_ARGOCD.md)", readme)
        self.assertTrue((ROOT / "docs/EXISTING_ARGOCD.md").is_file())
